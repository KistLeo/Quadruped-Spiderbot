...
// Config PWM value and provide servo functions, while blocking access to the PWM frequency changing fuction
...
#endif
//Reset the chip, set PWM frequency and
//enables auto increment of register addresses,
//which allows you to easily enter data into PCA9685
