...
//extern uint8_t flag_pca_tx;
//extern uint8_t flag_pca_rx;

I2C_HandleTypeDef *pca9685_i2c;
extern I2C_HandleTypeDef hi2c2;

uint8_t PCA_error_flag = 0;
...
PCA9685_STATUS PCA9685_SetBit(uint8_t Register, uint8_t Bit, uint8_t Value)
{
	...
	//if(HAL_OK != HAL_I2C_Mem_Read_IT(pca9685_i2c, PCA9685_ADDRESS, Register, 1, &tmp, 1))
	{
	...
	//if(HAL_OK != HAL_I2C_Mem_Write_IT(pca9685_i2c, PCA9685_ADDRESS, Register, 1, &tmp, 1))
	{
		return PCA9685_ERROR;
	}
...
PCA9685_STATUS PCA9685_SoftwareReset(void)
{
	...
	//if(HAL_OK == HAL_I2C_Master_Transmit_IT(pca9685_i2c, 0x00, &cmd, 1))
	{
		return PCA9685_OK;
	}
...
PCA9685_STATUS PCA9685_SetPwmFrequency(uint16_t Frequency)
{
	...
	//HAL_I2C_Mem_Write_IT(pca9685_i2c, PCA9685_ADDRESS, PCA9685_PRESCALE, 1, &Prescale, 1); // Write Prescale value
	PCA9685_SleepMode(0);
...
//	HAL_I2C_Mem_Write_DMA(hi2c, DevAddress, MemAddress, MemAddSize, pData, Size)
	...
	//if((HAL_OK != HAL_I2C_Mem_Write_IT(pca9685_i2c, PCA9685_ADDRESS, RegisterAddress, 1, Message, 4)) && (flag_pca_tx == 1))
	{
		PCA_error_flag = 1;
		HAL_GPIO_WritePin(GPIOD, GPIO_PIN_15, SET);
...
#ifdef PCA9685_SERVO_MODE
	//PCA9685_SetPwmFrequency(47); //Module dởm
	PCA9685_SetPwmFrequency(50); //Module xịn
#else
